...
<nav class="navbar navbar-expand-lg fixed-top" style="background: black; color: white;">
        ...
        <a class="navbar-brand" href="index.php">
          <h1 style="color:  rgb(5, 209, 245); font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;">Vidva </h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarcollapse">
           <div class="navbar-nav">
               <a href="index.php" class="nav-item nav-link" style="color: lightgray;">Home</a>
               <a href="login.php" class="nav-item nav-link" style="color: lightgray;">Login</a>
           </div>
           <div class="navbar-nav ml-auto">
               <a href="signup.php" class="nav-item nav-link btn btn-ig btn-info text-light">Sign Up</a>
           </div>
        </div>
</nav>
