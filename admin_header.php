...
<nav class="navbar navbar-expand-lg fixed-top" style="background: black; color: white;">
        ...
        <a class="navbar-brand" href="admin_dashboard.php">
            <h2 style="color: blue; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;">Admin Page</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarcollapse">
           <div class="navbar-nav">
               <a href="admin_dashboard.php" class="nav-item nav-link" style="color: lightgray;">Home</a>
               <a href="admin_profile.php" class="nav-item nav-link" style="color: lightgray;">Profile</a>
               <a href="admin_users.php" class="nav-item nav-link" style="color: lightgray;">View Users</a>
               <a href="upload.php" class="nav-item nav-link" style="color: lightgray;">Upload Movie</a>
               <a href="admin_movie.php" class="nav-item nav-link" style="color: lightgray;">Manage Movies</a>
           </div>
           <div class="navbar-nav ml-auto">
               <a href="admin_signup.php" class="nav-item nav-link btn btn-ig btn-info text-light">Add New User</a>
           </div>
        </div>
</nav>
